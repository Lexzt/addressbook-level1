...
//    private static final int PERSON_DATA_INDEX_EMAIL = 2;
    ...
    */
    ...
    private static void addPersonToAddressBook(HashMap<String,String> person) {
        ...
        personData.put(PERSON_PROPERTY_NAME,person.get(PERSON_PROPERTY_NAME));
        personData.put(PERSON_PROPERTY_EMAIL,person.get(PERSON_PROPERTY_EMAIL));
        personData.put(PERSON_PROPERTY_PHONE, person.get(PERSON_PROPERTY_PHONE));

        ALL_PERSONS.add(personData);
